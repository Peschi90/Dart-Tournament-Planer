...
// Buttons
        ...
        try
  {
    ...
    private async void Register_Click(object sender, RoutedEventArgs e)
    {
        try
        {
            // Deaktiviere UI während Registrierung
            RegisterButton.IsEnabled = false;
            CancelButton.IsEnabled = false;
            GenerateIdButton.IsEnabled = false;
            TournamentIdTextBox.IsEnabled = false;
            
            // ✅ VERBESSERT: Zeige Loading-Animation und ändere Button-Aussehen
            var originalContent = RegisterButton.Content;
            var originalBackground = RegisterButton.Background;
            
            // Animierter Loading-Text mit Spinner
            RegisterButton.Content = "⏳ " + (_localizationService?.GetString("RegisteringTournament") ?? "Registriere...");
            
            // Ändere Farbe zu Orange/Gelb während des Ladens
            RegisterButton.Background = new System.Windows.Media.SolidColorBrush(
                System.Windows.Media.Color.FromRgb(255, 165, 0)); // Orange
            
            // ✅ NEU: Füge subtile Opacity-Animation hinzu
            ...
            RegisterButton.BeginAnimation(System.Windows.UIElement.OpacityProperty, opacityAnimation);
            
            System.Diagnostics.Debug.WriteLine("🔄 Registration started - UI feedback activated");
            ...
            // Stoppe Animation
            RegisterButton.BeginAnimation(System.Windows.UIElement.OpacityProperty, null);
            RegisterButton.Opacity = 1.0;

            if (success)
            {
                // ✅ VERBESSERT: Zeige Success-State kurz an
                RegisterButton.Content = "✅ " + (_localizationService?.GetString("RegistrationSuccessful") ?? "Erfolgreich!");
                RegisterButton.Background = new System.Windows.Media.SolidColorBrush(
                    System.Windows.Media.Color.FromRgb(34, 197, 94)); // Grün
                
                System.Diagnostics.Debug.WriteLine("✅ Registration successful - showing success state");
                
                // Kurze Verzögerung damit User den Success-State sehen kann
            ...
            {
                // ✅ VERBESSERT: Zeige Error-State
                RegisterButton.Content = "❌ " + (_localizationService?.GetString("RegistrationFailed") ?? "Fehlgeschlagen");
                RegisterButton.Background = new System.Windows.Media.SolidColorBrush(
                    System.Windows.Media.Color.FromRgb(239, 68, 68)); // Rot
                
                System.Diagnostics.Debug.WriteLine("❌ Registration failed - showing error state");
                
                // Warte kurz, dann stelle UI wieder her
