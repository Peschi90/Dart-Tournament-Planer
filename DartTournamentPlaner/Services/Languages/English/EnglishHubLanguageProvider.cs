...
public class EnglishHubLanguageProvider : ILanguageSection
{
    public Dictionary<string, string> GetSectionTranslations()
    {
        return new Dictionary<string, string>
        {
            ...
            // ⭐ NEW: Hub Registration Dialog
            ["HubRegistrationDialogTitle"] = "Register with Hub",
            ["HubRegistrationDialogSubtitle"] = "Register your tournament for live scoring",
            ["TournamentIdLabel"] = "Tournament ID (optional):",
            ["TournamentIdPlaceholder"] = "Leave empty for automatic ID generation",
            ["GenerateNewIdTooltip"] = "Generate new ID",
            ["TournamentIdTipTitle"] = "💡 Tip:",
            ["TournamentIdTipText"] = "Leave the field empty for automatic ID generation.",
            ["TournamentIdNoteTitle"] = "📌 Note:",
            ["TournamentIdNoteText"] = "Use a known ID to resume an existing tournament.",
            ["CancelButton"] = "Cancel",
            ["RegisterButton"] = "Register",
            ["RegisteringTournament"] = "Registering tournament...",
            ["CustomTournamentIdUsed"] = "Using custom tournament ID: {0}",
            ["AutoGeneratedTournamentId"] = "Auto-generated tournament ID: {0}",
